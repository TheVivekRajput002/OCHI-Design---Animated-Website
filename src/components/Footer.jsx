...
function Footer() {
    return (
        <div className='flex w-full h-screen bg-zinc-900 py-7 px-15'>
            <div className="w-1/2 h-full flex flex-col justify-between">
                <div className="heading">
                    <h1 className='text-[7vw] leading-none font-semibold'>EYE-</h1>
                    <h1 className='text-[7vw] leading-none font-semibold'>OPENING</h1>
                </div>
                <div className="ochi">
                    <div className="logo">
            ...
            <div className="w-1/2 pl-7 ">
                <h1 className='text-[5vw] leading-none font-bold uppercase mb-10'>Presentations</h1>
                    ...
                    <div className="w-1/2 flex flex-col gap-10">
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <div className="links flex flex-col">
                                ...
                                <a className='mb-4' href="#">Vancouver, Canada</a>
                                <a href="#">T30 Chukarina St</a>
                        ...
                        <div className="links flex flex-col">
                            <a href="#">© ochi design 2026. Legal Terms</a>
                        </div>
