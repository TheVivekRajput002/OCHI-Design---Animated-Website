...
function Navbar() {
    ...
    return (
        <motion.nav
            ...
            className='fixed z-[99] w-full px-20 py-8 font-["Neue Montreal"] flex justify-between items-center'>
            <div className="logo">
            ...
            <div className="links flex gap-10">
                {["Services", "Our Work", "About Us", "Insights", "Contact"].map((item, index) => (
                    <a key={index} href="" className={`text-lg font-light ${index === 4 && "ml-32"}`}>{item}</a>
                ))}
            </div>
